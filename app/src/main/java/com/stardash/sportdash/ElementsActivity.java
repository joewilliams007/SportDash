...
public class ElementsActivity extends AppCompatActivity {
    ...
    public void addPause(View view) {
        setText("pause","A break is crucial for a perfect WorkOut.","https://www.urmc.rochester.edu/news/publications/health-matters/time-out-why-you-need-to-a-break-from-exercise","30","seconds");
    }
    ...
    private void setText(String elementName, String description, String helpLink, String seconds, String format) {
        ...
        editTextAdvice.setText(helpLink);
